      ...
      <div className="shrink-0 bg-gradient-to-l from-[#7B2FBE] to-[#5a1f8e] px-6 py-3 shadow-lg border-b border-white/10 pt-[24px] pb-[24px]">
        <div className="flex items-center justify-between relative">
          ...
          <div className="flex items-center gap-2 shrink-0">
            ...
            <button
              onClick={handleExit}
              className="flex items-center gap-1.5 bg-white/10 hover:bg-white/20 backdrop-blur-sm px-3 py-2 rounded-xl text-xs font-bold transition-all border border-white/15 text-[#ffffff] border-t-[#ffffff26] border-r-[#ffffff26] border-b-[#ffffff26] border-l-[#ffffff26] border-t-[2px] border-r-[2px] border-b-[2px] border-l-[2px] rounded-tl-[100px] rounded-tr-[100px] rounded-br-[100px] rounded-bl-[100px] pt-[10px] pb-[10px] pl-[8px] pr-[8px]"
            >
              <LogOut size={14} />
              الخروج
            </button>
