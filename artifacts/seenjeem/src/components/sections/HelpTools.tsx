...
const tools = [
  ...
  },
  {
    ...
    color: "from-red-400/15 to-red-500/5",
      ...
      <div className="container mx-auto px-4">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
          {tools.map((tool, idx) => (
            ...
            >
              <div className="absolute inset-0 bg-foreground/3 opacity-0 group-hover:opacity-100 transition-opacity"></div>
              ...
              <div className="bg-foreground/5 rounded-xl py-2 px-4 w-full text-sm text-primary font-bold z-10 border border-border">
                {tool.timing}
              </div>
            </motion.div>
          ))}
